...
SERV1_APP_ConnHandleNotEvt_t SERV1HandleNotification;
...
{
  6, AD_TYPE_COMPLETE_LOCAL_NAME, 'G', 'C', '_', 'X', 'X',  /* Complete name */
...
SVCCTL_UserEvtFlowStatus_t SVCCTL_App_Notification(void *p_Pckt)
{
  ...
  switch (p_event_pckt->evt)
  {
    case HCI_DISCONNECTION_COMPLETE_EVT_CODE:
    {
      ...
      SERV1HandleNotification.EvtOpcode = SERV1_DISCON_HANDLE_EVT;
      SERV1HandleNotification.ConnectionHandle = p_disconnection_complete_event->Connection_Handle;
      SERV1_APP_EvtRx(&SERV1HandleNotification);
    ...
    case HCI_LE_META_EVT_CODE:
    {
      ...
      switch (p_meta_evt->subevent)
      {
        ...
        case HCI_LE_ENHANCED_CONNECTION_COMPLETE_SUBEVT_CODE:
        {
          ...
          SERV1HandleNotification.EvtOpcode = SERV1_CONN_HANDLE_EVT;
          SERV1HandleNotification.ConnectionHandle = p_enhanced_conn_complete->Connection_Handle;
          SERV1_APP_EvtRx(&SERV1HandleNotification);
        ...
        case HCI_LE_CONNECTION_COMPLETE_SUBEVT_CODE:
        {
          ...
          SERV1HandleNotification.EvtOpcode = SERV1_CONN_HANDLE_EVT;
          SERV1HandleNotification.ConnectionHandle = p_conn_complete->Connection_Handle;
          SERV1_APP_EvtRx(&SERV1HandleNotification);
    ...
    case AD_TYPE_MANUFACTURER_SPECIFIC_DATA:
      {
        ...
        p_adv_data[i+6] = FW_ID_GC_SERVER; /* FW ID */
...
{
  GCS_Button1TriggerReceived();
  return;
}

void APPE_Button2Action(void)
{
  GCS_Button2TriggerReceived();
  return;
}

void APPE_Button3Action(void)
{
  GCS_Button3TriggerReceived();
  return;
}
#endif
